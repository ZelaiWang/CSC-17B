...
void MainScene::createFlowers()
{
    ...
    flower->setPos(sceneRect().bottomRight().x() - fmod(qrand(),flower->sceneBoundingRect().height())
    ...
    flower->setPos(sceneRect().topRight().x() - fmod(qrand(),flower->sceneBoundingRect().height())
                   , sceneRect().top());
